...
set NOT_BRANCH_PC_CHECK [expr {$NOT_BRANCH_PC_CHECK == 1 ? "+define+NOT_BRANCH_PC_CHECK ": ""}]
set ANALYZE_FILE "analyze -sv property/isa.sv "
set ANALYZE_COMMAND \
$ANALYZE_FILE$PIPELINE_FOLLOWER_CHECK$REGFILE_CHECK$ANDI_CHECK$BGE_CHECK$JAL_CHECK$LBU_CHECK$AUIPC_CHECK$NOT_BRANCH_PC_CHECK
